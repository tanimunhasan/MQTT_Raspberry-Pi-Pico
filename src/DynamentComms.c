/******************************************************
*
*       PROCESS SENSING TECHNOLOGIES (Mansfield)
*
*           Pico Premier Interface Example
*
*******************************************************
* Copyright(C) Process Sensing Technologies 2024.  
*  All rights reserved
*******************************************************
* Project Description :
*
* Example program to interface to a Premier Sensor 
* sensor using either MODBUS protocol (for sensors with
* firmware above V09.02.*) or Dynament Protocol to read
* gas sensor readings
*
*******************************************************
* File : DynamentComms.c
*
* Description: Communications routines for interfacing to 
*              a Dynament Premier sensor using the Dynament
*              protocol
*
* Author : K J Corcoran
*
* Revision : Releast Notes.txt
*
*******************************************************/
...
bool SendDynamentPacket(uint8_t cmd, uint8_t variableID, uint8_t dlen, uint8_t *dataPtr)
{
    ...
    //***TEST*** - send packet to terminal port for debug purposes
    //printf ("TX: ");
    //for (int idx=0; idx < txBufPtr; idx++)
...
void ReadLiveData2Response(uint8_t *dataPtr, int len) {
    ...
    //***TEST*** - print out received character for debug purposes 
    //printf("ReadLiveData2Response: %02X\n", *dataPtr);
    //printf("RLD2 -- Stage 1\n"); 
    //***TEST***
...
{
    //printf("Setting readDualGasCallBack to: %X\n", cb); //***TEST***
